...
public class TradeStationProvider : ITradingProvider
{
    private readonly string _apiKey;
    private readonly string _secretKey;
    private readonly bool _paperTrading;
    
    public string ProviderName => "TradeStation";
    public bool IsConnected { get; private set; }
    public bool IsPaperTrading => _paperTrading;
    public decimal AccountBalance { get; private set; }

    public TradeStationProvider(string apiKey, string secretKey, bool paperTrading = true)
    {
    ...
    public async Task<Account> GetAccountAsync()
    {
        ...
        return new Account { AccountId = "TS123", Cash = 100000m, Status = AccountStatus.Active };
    }
